...
parser.add_argument('--data_path', type=str, default='./test_datasets/demo_3dkd_affinity', help='./pdbfile/davis/na_plp_pts, home/tianyn/source_tyn/pkidti/pdbfile/davis/davis_gra_seq_pts_0707')
