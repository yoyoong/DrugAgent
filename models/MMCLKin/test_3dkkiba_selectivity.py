...
def comput_sds(real_results, pred_results, cutoff):
    n = 0
...
path = './pkls/3dkkiba_selectivity/MMCLKin_DTI_pearson_best.pkl'
lstm_dropout = 0.2
alpha = 0.2
num_heads = 2
hidden_dim = 256
...
with torch.no_grad():
    for i, x_feats in enumerate(valid_dataset):
        ...
        n, len_real_results, real_sds, m, len_pred_results, pred_sds= comput_sds(total_y_true, total_y_pred, cutoff)
